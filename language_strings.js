module.exports = {
    'en': {
        translation: {
            ...
            HELP: 'I will ask you a Mathematical question. If you get it right, you win a point. Do you want to start the game?',
            PLAYERS_NUMBER: "<say-as interpret-as='interjection'>Awesome!</say-as> Tell me how many players are playing.",
            INVALID_PLAYERS: "That is an invalid number. There should be at least one player. Please tell me how many players are playing the game.",
            ...
            QUESTION_SQUARE: "<s>What is the square of %d?</s> ",
            ROUND_COMPLETED: "Round %d Completed! The score is ",
            POINTS: "<s>%d points to player %d. </s>",
            NEXT_ROUND: "Are you ready for round %d?",
            GAME_FINISHED_WINNER: "GAME OVER! The overall winner is Player %d. You are crowned a Speedy Mathematician! <audio src='https://s3.amazonaws.com/ask-soundlibrary/musical/amzn_sfx_trumpet_bugle_04.mp3'/> Congratulations! <s> Do you wish to play again? </s>",
            GAME_FINISHED_DRAW: "GAME OVER! The overall winners are players %s. Ya'll are crowned Speedy Mathematicians! <audio src='https://s3.amazonaws.com/ask-soundlibrary/musical/amzn_sfx_trumpet_bugle_04.mp3'/> Congratulations! <s> Do you wish to play again? </s>",
            ...
            QUESTION_FACORIAL: "<s>What is the factorial of %d?</s> ",
            ...
            QUESTION_MODULO: "<s>What is the remainder of %d modulo %d ?</s> ",
            WRONG_FACTORIAL: "<say-as interpret-as='interjection'> %s!</say-as> %d is incorrect. <s>The remainder of %s is %d. </s> ",
            QUESTION_EQUATION: "<s> What is the result of %s ? </s>",
            QUESTION_NO: "Question %d for Player %d. ",
            EQUATION: "OPERATE THE OPERANDS! In this round I will give you an operation to solve. Solve it quick, give me the answer, and you can snatch a point! Do you want me to give you an example?",
            WRONG_EQUATION: "<say-as interpret-as='interjection'> %s!</say-as> %d is incorrect. <s>The result of %s is %d. </s> ",
            EQUATION_EXPLAIN: "You will be given an operation with two operands. For example, 480 minus 100, or 90 divided by 10. Reply with the correct answer and win a point. Should we proceed?",
            MODULO_EXPLAIN:"A modulo operation is one wherein the result is the remainder obtained after a division operation. For example the remainder of 15 divided by 4 is 3. Reply with the correct result and score a point. Should we proceed?"
        }
    }
};